import { StyleSheet, Text, TouchableOpacity, View, Image, TextInput, Dimensions, Platform } from "react-native";
...
const styles = StyleSheet.create({
  ...
  inputWrapper: {
    ...
    borderWidth: Platform.OS == "ios" ? .3 : .9,
    borderRadius: 10,
    marginBottom: 30,
    height: 55,
    flexDirection: "row",
